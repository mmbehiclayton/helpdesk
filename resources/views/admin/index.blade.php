...
@section('content')
          <div class="container px-6 mx-auto grid">
            ...
            >
              My Reports | Received Reports
            </h2>
            <!-- CTA -->
            <a
              class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-teal-900 bg-teal-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple"
              href="#"
            >
