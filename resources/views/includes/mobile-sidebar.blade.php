...
<aside
    ...
    <div class="py-4 text-gray-500 dark:text-gray-400">
        ...
        <ul>         
            <li class="relative px-6 py-3"><!--Drop Down Starts-->
                <button
                ...
                <svg
                    ...
                    viewBox="0 0 24 24"
                    stroke="currentColor">
                    <path d="M3 7a1 1 0 011-1h4l2-2h6a1 1 0 011 1v14a1 1 0 01-1 1H4a1 1 0 01-1-1V7z"></path>
                </svg>
                ...
                <template x-if="isPagesMenuOpen">
                    ...
                    >
                        ...
                        >
                            <a class="w-full" href="{{ route('reports.index') }}">Sent Reports</a>
                        </li>
                        <li
                                class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                        >
                            <a class="w-full" href="{{ route('admin.home') }}">
                                Received Reports
                            </a>
                        </li>
