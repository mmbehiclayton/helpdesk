...
<div class="h-full bg-gray-200 p-8">
                    ...
                    <div class="w-full bg-white shadow-xl rounded-lg flex overflow-x-auto custom-scrollbar">
                        <div class="w-64 px-4">
                            ...
                            <div class="px-2 pt-4 pb-8 border-r border-gray-300">
                                <ul class="space-y-2">
                                    ...
                                    <li>
                                        <a class="hover:bg-gray-500 hover:bg-opacity-10 hover:text-primary flex items-center text-gray-700 py-1.5 px-4 rounded space-x-2 cursor-pointer">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <li>
                                        <a class="hover:bg-gray-500 hover:bg-opacity-10 hover:text-primary flex items-center justify-between text-gray-700 py-1.5 px-4 rounded space-x-2 cursor-pointer">
                                            <span class="flex items-center space-x-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="flex-1 px-2">
                            ...
                            <div class="mb-6">
                                <h4 class="text-lg text-gray-800 font-bold pb-2 mb-4 border-b-2">{{ $report->subject }}</h4>
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <img src="./../../assets/img/message3.jpg" class="rounded-full w-8 h-8 border border-gray-500">
                                        <div class="flex flex-col ml-2">
                                            <span class="text-sm font-semibold">Full Name Here</span>
                                            <span class="text-xs text-gray-400">From: sender@example.com</span>
                                        </div>
                                    </div>
                                    <span class="text-sm text-gray-500">{{ $report->created_at->diffForHumans() }}<br><small>{{ $report->created_at->format('h:i a, d F Y') }}</small></span>
                                </div>
